<div class="raffles index">
	...
	<tr>
		...
		<td><?php echo h($raffle['Raffle']['raffledate']); ?>&nbsp;</td>
		<td><?php echo h($raffle['Raffle']['locked']); ?>&nbsp;</td>
		<td class="actions">
			<?php
				if ($raffle['Raffle']['locked'] == 'N') {
					echo $this->Html->link(__('Raffle'), array('action' => 'get_winners', $raffle['Raffle']['id']));
				}
			?>
