<div class="messages index">
	...
	<tr>
		...
		<td><?php echo h($message['Message']['mobile']); ?>&nbsp;</td>
		<td><?php echo h($message['Message']['message']); ?>&nbsp;</td>
		<td><?php echo h($message['Message']['answer']); ?>&nbsp;</td>
		<td><?php echo h($message['Message']['posteddate']); ?>&nbsp;</td>
		<td><?php echo h($message['Message']['valid']); ?>&nbsp;</td>
		<td><?php echo h($message['Message']['winner']); ?>&nbsp;</td>
		<td><?php echo h($message['Message']['prize']); ?>&nbsp;</td>
		<td class="actions">
